...
export function lockGateFailures(g: LockGateInput): string[] {
  ...
  const checks: [boolean, string][] = [
    ...
    [g.oddsAcceptedConfirmed ?? true, "Live odds not accepted"],
    [g.stakeAcceptedConfirmed ?? true, "Stake not accepted"],
    [g.liquidityEnoughConfirmed ?? true, "Liquidity not confirmed"],
